...
void main() {
  ...
  group('MorphingAnimationConfig Tests', () {
    test('should create crossFade config correctly', () {
      final config = MorphingAnimationConfig.crossFade(
    ...
    test('should create scale config correctly', () {
      ...
      expect(config.duration, equals(Duration(milliseconds: 400)));
    ...
    test('should create custom config correctly', () {
      Widget Function(Widget child, Animation<double> animation) customBuilder =
          (child, animation) => Opacity(opacity: animation.value, child: child);
